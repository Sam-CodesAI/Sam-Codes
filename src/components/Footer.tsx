...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-white/[0.06] bg-[#05070d]/80 backdrop-blur-md px-4 sm:px-6 py-12 text-xs font-mono text-slate-400">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-2.5 py-1 rounded-lg bg-white/[0.03] hover:bg-white/[0.08] border border-white/[0.08] text-slate-400 hover:text-sky-300 text-[10px] flex items-center gap-1.5 transition-colors cursor-pointer"
          >
            <Terminal size={12} />
            <span>Shift+D</span>
          </button>
