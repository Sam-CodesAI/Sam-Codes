...
export default function ProcessSection() {
  ...
  return (
    ...
    >
        ...
        {processStepsData.map((s, idx) => {
          ...
          return (
            <button
              ...
              className={`p-3 sm:p-4 rounded-xl text-left border transition-all cursor-pointer relative overflow-hidden ${
                isActive
            ...
            >
              ...
              <div className="font-bold text-xs sm:text-sm tracking-wide">{s.label}</div>
            </button>
          );
        })}
      </div>
      ...
      <div className="rounded-3xl bg-gradient-to-br from-white/[0.04] to-white/[0.01] border border-white/[0.08] p-6 sm:p-10 relative overflow-hidden">
        <div className="absolute top-0 right-0 p-8 font-mono text-7xl sm:text-9xl font-black text-white/[0.02] select-none pointer-events-none">
          0{activeStep.step}
        </div>
