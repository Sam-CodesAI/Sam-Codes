...
('x', 'X (Twitter)', 'X', '@Tempest_Store', 'https://x.com/Tempest_Store', 'Tech discussions, build progress, and direct messaging', 3, true),
('reddit', 'Reddit', 'Reddit', 'u/SamarthBuilds_', 'https://www.reddit.com/u/SamarthBuilds_/', 'Builder community, discussions, and open-source feedback', 4, true),
